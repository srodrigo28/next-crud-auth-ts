// src/app/dashboard/produto/page.tsx
"use client"
...
export default function ProductList() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : "Erro ao carregar produtos. Tente novamente."
  ...
  const openProductModal = (product: ProductData | null = null) => {
  ...
  const handleProductSaved = (savedProduct: ProductData) => {
