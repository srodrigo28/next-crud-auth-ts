...
import { ProductData } from '../../../../lib/types/product'; // Import ProductData type

export default function ProductDetail() {
  const [product, setProduct] = useState<ProductData | null>(null); // Explicitly type product as ProductData | null
